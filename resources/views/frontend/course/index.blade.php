...
@section('content')
    ...
    <div class="ui center aligned header basic raised segment">
        <div class="teal ui buttons">
            <a class="ui @if($type=='') active @endif large button" href="{{ route('course.index') }}">全部</a>
            ...
            <a class="ui @if($type=='test') active @endif large button" href="{{ route('course.index', ['type' => 'test']) }}">测试</a>
        </div>
    </div>
