        ...
        <div class="ui grid">
            <div class="twelve wide column">
                ...
                <div class="ui large middle aligned divided relaxed list padded segment">
                    <form class="ui form success" METHOD="post" action="{{ route('topics.update', ['id' => $topic->id]) }}">
                        <input type="hidden" name="_method" value="PUT" />
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="field">
                            <label></label>
                            <input type="text" name="title" placeholder="请填写标题" value="{{ $topic->title }}">
                        </div>
                        <div class="ui success message">
                            <div class="header"><i class="info circle icon"></i>提示</div>
