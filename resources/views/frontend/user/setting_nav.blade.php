...
<div class="ui large fluid vertical pointing menu">
    <a class="item" href="{{ route('user.edit', Auth::id()) }}">
        <i class="black user icon"></i>
        个人信息
    </a>
    <a class="item" href="{{ route('user.edit_avatar', Auth::id()) }}">
        <i class="black image icon"></i>  修改头像
    </a>
    <a class="item" href="{{ route('user.edit_password', Auth::id()) }}">
        <i class="black alarm icon"></i>  修改密码
    </a>
